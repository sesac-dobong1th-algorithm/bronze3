...
r = [25, 10, 5, 1]  # 쿼터,다임,니켈,페니

m = []  # 가격
for _ in range(t):  # 테스트 케이스만큼 반복
    m.append(int(input()))  # 가격 저장

for i in m:  # 가격을 하나씩 불러온다
    for j in r:  # 쿼터 다임 니켈 페니를 하나씩 부러온다
        print(i // j, end=" ")  # 나눈 몫을 출력
        i = i % j  # i를 j로 나눈 나머지를 다시 i에 저장
    print()  # 한칸 띄는 용도
